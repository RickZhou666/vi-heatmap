...
from tabs.mweb_heatmap import mweb_heatmap_tab
...
tab = st.radio(
        "Choose a dashboard",
        ["📋 VI Modules Surface/ View/ Engagement", "📊 dWeb Heatmap", "📊 Native/ mWeb Heatmap", "📋 VI Modules Surface/ View/ Engagement by Cuts"],
        horizontal=True,
